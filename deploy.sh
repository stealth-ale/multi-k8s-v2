...
kubectl set image deployments/client-deployment client=alehti/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=alehti/multi-worker:$SHA
